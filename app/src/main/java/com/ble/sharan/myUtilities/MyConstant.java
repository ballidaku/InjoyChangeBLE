...
//    public static final String WEIGHT_UNIT = "weight_unit";
    ...
    //ALARM
    public static final String ALARM_FIRST = "alarm_first";
    public static final String ALARM_SECOND = "alarm_second";
    public static final String ALARM_THIRD = "alarm_third";


    public static final String IS_ALARM_FIRST_ACTIVATED = "is_alarm_first_activated";
    public static final String IS_ALARM_SECOND_ACTIVATED = "is_alarm_second_activated";
