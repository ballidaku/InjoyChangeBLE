        ...
        UploadCancelFragment.CancelFragmentListener, PermissionRationaleFragment.PermissionDialogListener
{
    ...
    private TextView txtv_instruction;
    private TextView txtv_heading;
    private ProgressBar mProgressBar;


    LinearLayout linearLayoutFirmwareUpdate;
    ...
    boolean isUpLoadedSuccessfull=false;


//    String myDeviceAddress;
//    String myDeviceName;

    boolean goThrough2 = false;
    boolean goThrough3 = false;
    ...
    private final DfuProgressListener mDfuProgressListener = new DfuProgressListenerAdapter()
    {
        ...
        public void onDfuCompleted(final String deviceAddress)
        {
            ...
            isUpLoadedSuccessfull=true;

            mProgressBar.setVisibility(View.INVISIBLE);
            mTextPercentage.setVisibility(View.INVISIBLE);
//            mTextUploading.setVisibility(View.INVISIBLE);
            mTextUploading.setText("Done");
            mTextUploading.setTextSize(18.0f);
            mTextUploading.setTypeface(mTextPercentage.getTypeface(), Typeface.BOLD);

            mTextUploading.setOnClickListener(new View.OnClickListener()
            {
                @Override
...
//            mTextPercentage.setText(R.string.dfu_status_completed);
        ...
        {
            Log.e(TAG, "9      " + deviceAddress);


            if (goThrough2 && goThrough3)
            {
                clearMyUI();
    ...
    public void onBackPressed()
    {
        ...
        returnIntent.putExtra("result",isUpLoadedSuccessfull);
...
//        myDeviceAddress= getIntent().getStringExtra("device_address");
//        myDeviceName= getIntent().getStringExtra("device_name");
//
//        Log.e(TAG,"address   "+myDeviceAddress+"   name    "+myDeviceName );
...
//        File file = new File(sdCardRoot, "CS11753b32.zip");

        //File file = new File("/sdcard/Audio/CS11753b32.zip");


        Log.e(TAG, "ABC    " + file.getPath());
    ...
    public File getFILE()
    {
        File file = new File(getCacheDir() + "/CS11753b32.zip");
        /*if (!file.exists()) */
        try
        {

            InputStream is = getAssets().open("CS11753b32.zip");
...
/*    private void copyAssets()
    {
        ...
        String filename = "CS11753b32.zip";
        try
        {
    ...
    private void setGUI()
    {
        ...
        txtv_instruction=(TextView)findViewById(R.id.txtv_instruction);
        txtv_heading=(TextView)findViewById(R.id.txtv_heading);

        linearLayoutFirmwareUpdate=(LinearLayout)findViewById(R.id.linearLayoutFirmwareUpdate);
        linearLayoutFirmwareUpdate.setVisibility(View.GONE);

        final Typeface typeface = Typeface.createFromAsset(getAssets(), getString(R.string.font_path));

        txtv_heading.setTypeface(typeface);
        txtv_instruction.setTypeface(typeface);
        txtv_instruction.setMovementMethod(new ScrollingMovementMethod());
    ...
    private ScanCallback scanCallback = new ScanCallback() {
        ...
        public void onBatchScanResults(final List<ScanResult> results)
        {
            ...
            for (final ScanResult result : results)
            {
                ...
                if(result.getDevice().getName() != null && result.getDevice().getName().equals("CH_OTA_"))
                {
                    onUpLoadManually(result.getDevice().getAddress());
...
/*	public void onSelectFileHelpClicked(final View view) {
    ...
    public void onUpLoadManually(String address)
    {
       ...
       /* if (isDfuServiceRunning())
        ...
        final SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
        final SharedPreferences.Editor editor = preferences.edit();
        editor.putString(PREFS_DEVICE_NAME, "CH_OTA_");
        editor.putString(PREFS_FILE_NAME, mFileNameView.getText().toString());
        editor.putString(PREFS_FILE_TYPE, mFileTypeView.getText().toString());
        editor.putString(PREFS_FILE_SIZE, mFileSizeView.getText().toString());
        editor.apply();
       ...
       // String myAddress = mSelectedDevice.getAddress().toString();

       // String value1 = myAddress.subSequence(15, 17).toString();
       // int value2 = Integer.parseInt(value1) + 1;

      //  myAddress = myAddress.replace(value1, String.valueOf(value2));


        Log.e(TAG, "MANUPULATED     " + address);


        final DfuServiceInitiator starter = new DfuServiceInitiator(address)
                .setDeviceName("CH_OTA_")
                .setKeepBond(keepBond)
                .setForceDfu(forceDfu)
                .setPacketsReceiptNotificationsEnabled(enablePRNs)
                .setPacketsReceiptNotificationsValue(numberOfPackets)
    ...
    private void showMyUploadCancelDialog()
    {
        final LocalBroadcastManager manager = LocalBroadcastManager.getInstance(this);
        final Intent pauseAction = new Intent(DfuService.BROADCAST_ACTION);
    ...
    public void onDeviceSelected(final BluetoothDevice device, final String name)
    {
        ...
        linearLayoutFirmwareUpdate.setVisibility(View.VISIBLE);
